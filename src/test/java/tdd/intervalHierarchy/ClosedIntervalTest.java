...
public class ClosedIntervalTest extends TestCase {
	...
	public void testIsIntersectedOverlapingByLeftOnePoint() {
		Interval one = new ClosedIntervalBuilder().min(5).max(14).build();
		Interval another = new ClosedIntervalBuilder().min(2).max(5).build();
		assertTrue(one.isIntersected(another));
	}
	...
	public void testIsIntersectedOverlapingByRightOnePoint() {
		Interval one = new ClosedIntervalBuilder().min(3).max(14).build();
		Interval another = new ClosedIntervalBuilder().min(14).max(22).build();
		assertTrue(one.isIntersected(another));
	}
